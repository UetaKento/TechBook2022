...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    Dictionary<ARKitBlendShapeLocation, int> m_FaceArkitBlendShapeIndexMap;
        ...
        void Awake()
        {
            ...
            goalWeight = (int)Random.Range(150, 250);
            goalScoreText = GameObject.Find("GoalScoreText").GetComponent<Text>();
            weightScoreText = GameObject.Find("WeightScoreText").GetComponent<Text>();
            clearText = GameObject.Find("ClearText").GetComponent<Text>();
            goalScoreText.text = "Goal Score is " + goalWeight.ToString();
        }
...
#if UNITY_IOS && !UNITY_EDITOR
        int jawOpenIndex;
        int eyeWideLeftIndex;
        int eyeWideRightIndex;

        int jawOpenWeight;
        int eyeWideLeftWeight;
        int eyeWideRightWeight;
        ...
        jawOpenWeight = (int)skinnedMeshRenderer.GetBlendShapeWeight(jawOpenIndex);
        eyeWideLeftWeight = (int)skinnedMeshRenderer.GetBlendShapeWeight(eyeWideLeftIndex);
        eyeWideRightWeight = (int)skinnedMeshRenderer.GetBlendShapeWeight(eyeWideRightIndex);

        weightSum = jawOpenWeight + eyeWideLeftWeight + eyeWideRightWeight;

        weightScoreText.text = "Your score is " + weightSum.ToString();
